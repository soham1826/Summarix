    ...
    <div className="space-y-4">
      {points.map((point ,index) => {
        ...
        if(hasEmoji || isMainPoint){
           return(
                <div key={`key-${index}`} className="group relative bg-linear-to-br from-gray-200/[0.08] to-gray-400/[0.03] p-4 rounded-2xl border-gray-500/10 hover:shadow-lg transition-all">
